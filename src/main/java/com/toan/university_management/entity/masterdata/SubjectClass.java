...
@Table(name = "subject_class", 
    uniqueConstraints = {
        @UniqueConstraint(name = "uk_subject_class_code_deleted", columnNames = {"subject_class_code", "deleted"})
    },
    indexes = {
...
@SQLDelete(sql = "UPDATE subject_class SET deleted = true WHERE id = ?")
